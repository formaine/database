  ...
  return (
    <div className="navigation">
      <nav
        ...
        style={{ minHeight: "8vh", zIndex: 10000, position: "relative" }}
      >
        <div className={"container-fluid"}>
          ...
          <button
            ...
            data-target="navbarResponsiveCustom"
          ...
          >
            <AiOutlineMenu
              style={{ color: "white", transform: "scale(2)" }}
            ></AiOutlineMenu>
          </button>
          <div
            className={`${isNavCollapsed ? "collapse" : ""} navbar-collapse`}
            id="navbarResponsiveCustom"
          >
          ...
          {isNavCollapsed && (
            <div
              className="border-left induforLogo"
              style={{ height: "6vh", paddingLeft: "10px" }}
            >
              <span
                className={"induforLogo"}
                style={{
                  fontWeight: "bold",
                  color: "white",
                  paddingRight: "10px",
              ...
              <a
                target={"_blank"}
                href="https://induforgroup.com/about-us/usa/"
              ...
              >
                <svg
                  className={"induforLogo"}
                  viewBox="0 0 821.000000 1085.000000"
                ...
                >
                  <g
                    ...
                    stroke="none"
                  >
                    <path d="M3725 10839 c-298 -28 -703 -114 -950 -202 l-40 -14 -3 -3875 -2 -3875 132 -41 c350 -111 706 -172 1086 -188 l162 -7 0 4106 0 4107 -147 -1 c-82 -1 -188 -5 -238 -10z" />
                    <path d="M4920 6745 l0 -4025 28 6 c144 34 307 78 405 108 l117 37 -2 3876 -3 3876 -85 29 c-89 30 -419 118 -445 118 -13 0 -15 -475 -15 -4025z" />
                    <path d="M1244 9698 c-713 -691 -1143 -1595 -1234 -2593 -15 -167 -12 -589 5 -764 85 -849 423 -1636 979 -2280 97 -112 353 -371 367 -371 5 0 9 1377 9 3060 0 1683 -2 3060 -5 3060 -3 0 -57 -51 -121 -112z" />
                    <path d="M6830 6750 c0 -2250 3 -3060 11 -3060 20 0 311 299 420 431 779 942 1098 2158 883 3359 -126 702 -433 1357 -898 1912 -103 123 -391 418 -408 418 -4 0 -8 -1377 -8 -3060z" />
                    <path d="M5450 1790 c-72 -15 -166 -67 -205 -113 -48 -56 -75 -146 -75 -253 l0 -84 -80 0 -80 0 0 -130 0 -130 80 0 80 0 0 -535 0 -535 185 0 185 0 0 535 0 535 125 0 125 0 0 130 0 130 -126 0 -127 0 6 66 c8 105 51 133 200 134 l67 0 0 115 0 114 -37 11 c-50 15 -266 22 -323 10z" />
                    <path d="M0 895 l0 -885 200 0 200 0 0 885 0 885 -200 0 -200 0 0 -885z" />
                    <path d="M2980 1521 l0 -262 -37 26 c-54 37 -153 65 -252 71 -281 19 -502 -142 -576 -421 -29 -110 -40 -273 -27 -393 40 -355 221 -542 526 -542 145 0 236 30 336 112 42 34 50 35 50 6 0 -33 36 -87 66 -98 14 -6 86 -10 160 -10 l135 0 -3 848 c-2 663 -6 852 -16 869 -22 40 -50 47 -209 51 l-153 4 0 -261z m-61 -484 l56 -22 3 -322 2 -323 -42 -31 c-93 -68 -204 -94 -298 -69 -58 15 -121 80 -144 146 -29 86 -41 233 -28 342 21 170 86 264 209 298 63 18 169 10 242 -19z" />
                    <path d="M1417 1350 c-90 -16 -192 -51 -274 -95 -46 -24 -84 -41 -87 -37 -2 4 -7 22 -11 39 -3 18 -20 44 -37 58 -29 24 -34 25 -174 25 l-144 0 0 -665 0 -665 185 0 185 0 0 494 0 494 83 23 c110 30 261 38 306 14 61 -31 61 -35 61 -555 l0 -470 190 0 191 0 -3 548 c-4 622 -3 611 -84 700 -59 66 -126 92 -249 97 -49 2 -112 0 -138 -5z" />
                    ...
                    <path d="M8010 1336 c-72 -21 -111 -40 -178 -90 -40 -30 -64 -42 -66 -34 -3 7 -7 25 -10 40 -3 15 -17 40 -30 55 l-24 28 -151 3 -151 3 0 -665 0 -666 185 0 185 0 0 475 0 474 31 16 c57 30 183 56 297 62 l112 6 0 147 c0 145 0 148 -22 154 -37 9 -129 5 -178 -8z" />
                    <path d="M3632 793 c4 -629 1 -608 93 -699 75 -75 123 -89 305 -88 130 0 154 3 230 28 47 15 113 43 146 62 l62 34 6 -34 c3 -18 18 -44 32 -57 24 -23 33 -24 175 -27 l149 -4 0 666 0 666 -185 0 -185 0 0 -499 0 -499 -87 -28 c-115 -37 -255 -41 -300 -8 -64 46 -63 41 -63 562 l0 472 -191 0 -190 0 3 -547z" />
                  </g>
                </svg>
              </a>
            </div>
