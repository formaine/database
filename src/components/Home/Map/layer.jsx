...
const Layer = ({
  ...
  return (
    <div style={{ float: "left", width: "100%" }}>
      ...
      >
        <span>
          <AiOutlineInfoCircle className={"modalToggle"} onClick={openModal} />
          <Modal
            isOpen={modalIsOpen}
