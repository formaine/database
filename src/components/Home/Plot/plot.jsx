...
export const PlotMegaregion = ({
    ...
    useEffect(() => {
        if (passedData.length === 0) {
            ...
            const sitesTransposed = Object.keys(passedData).map(key => ({ key, value: passedData[key] }));
            ...
            >
                ...
                <Tabs selectedIndex={tabIndex} onSelect={index => setTabIndex(index)} >
                    ...
                    <TabPanel>
                        ...
                        <div className={"toggle"} style={{ justifyContent: 'center', display: 'flex'}}>
                            <Select
                            ...
                            />
                            <div style={{padding: '5px', fontWeight: 'bold'}}>Megaregion</div>
                ...
                />
                    ...
                    <TabPanel style={{width: widthP, height: "410px"}} >
                        {sitesArray ?
                         <Container style={{marginTop: 0, maxWidth: '100%', padding: '10px', overflowY: 'scroll', width: widthP, height: "410px"}}>
                             ...
                             />
                                 ...
                                 : <div className={"selectAvailable"}>Select an Available Site for More Information</div>
