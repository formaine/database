...
export const PlotInventory = ({ barColorInput, onClick }) => {
  const dataChartNode = useRef();

  const getInventory = () =>
    fetch(
      `https://raw.githubusercontent.com/eastcoasting/test/master/Inventory.json`
    );
  ...
  return (
    <div className={"plotInventory"} style={{ flexGrow: 1 }}>
      <Plot
