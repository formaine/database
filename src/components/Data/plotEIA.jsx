...
export const PlotEIA = ({ barColorInput, onClick }) => {
  ...
  const getMaine = () =>
    fetch(
      `https://api.eia.gov/series/?api_key=2227d28e3508a5f8ab4744b1bd3517a2&series_id=${myForm.mySelectKey}`
    );
  const getNE = () =>
    fetch(
      "https://api.eia.gov/series/?api_key=2227d28e3508a5f8ab4744b1bd3517a2&series_id=ELEC.PRICE.NEW-IND.Q"
    );
  ...
  React.useEffect(() => {
    if (data && data[0] && data[0].series && data[1] && data[1].series) {
      const [ME, NE] = data;
