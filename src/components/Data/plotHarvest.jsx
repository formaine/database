...
export const PlotHarvest = ({
    ...
    const getHarvest = () => fetch(`https://raw.githubusercontent.com/eastcoasting/test/master/harvest.json`);
        ...
        if (!data) {
            ...
            if (data) {
                ...
                for (var key in Inventory) {
                    ...
                    setDataTableXOtherSoftwood.push(Inventory[key]["Other Softwood Tons Cut"]);
